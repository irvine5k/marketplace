...
void main() {
  test('When call fromJson should return a correct model', () {
    final purchaseResponse = PurchaseResponseModel.fromJson(_responseJson);

    expect(purchaseResponse.success, _success);
    expect(purchaseResponse.errorMessage, '');
  });
  test('When compare two objects with same values, should return true', () {
    final purchaseResponse1 = PurchaseResponseModel.fromJson(_responseJson);
    final purchaseResponse2 = PurchaseResponseModel.fromJson(_responseJson);
